...
function generateFauxData(length) {
    var data = [];
    for(let i = 0; i <= length.length - 1; i++)data.push(1);
    return data;
}
...
const chartInstance = new (0, _autoDefault.default)(document.getElementById("acquisitions"), {
    type: "pie",
    data: data,
    options: {
        plugins: {
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":"2aojw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jokr5":[function(require,module,exports) {
/*
 * anime.js v3.2.1
